...
def patch_cuda_platform_deep_gemm_sm120() -> None:
    path = Path("/ai/vllm/DS4_SM120_Flash_VLLM_Experiment/venv/lib/python3.12/site-packages/vllm/platforms/cuda.py")
...
def patch_block_scaled_mm() -> None:
    path = Path(
        "/ai/vllm/DS4_SM120_Flash_VLLM_Experiment/venv/lib/python3.12/site-packages/vllm/model_executor/"
...
def patch_deep_gemm_e8m0_oracle_sm120() -> None:
    path = Path("/ai/vllm/DS4_SM120_Flash_VLLM_Experiment/venv/lib/python3.12/site-packages/vllm/utils/deep_gemm.py")
    source = path.read_text()
    old = (
...
def patch_flashmla_sparse_prefill() -> None:
    paths = (
        Path(
            "/ai/vllm/DS4_SM120_Flash_VLLM_Experiment/venv/lib/python3.12/site-packages/vllm/v1/attention/"
            "ops/flashmla.py"
        ),
        Path(
            "/ai/vllm/DS4_SM120_Flash_VLLM_Experiment/venv/lib/python3.12/site-packages/vllm/third_party/"
...
def patch_flashmla_sparse_prefill_workspace_factor() -> None:
    path = Path(
        "/ai/vllm/DS4_SM120_Flash_VLLM_Experiment/venv/lib/python3.12/site-packages/vllm/v1/attention/backends/"
...
def patch_vllm_memory_breakdown_logging() -> None:
    path = Path("/ai/vllm/DS4_SM120_Flash_VLLM_Experiment/venv/lib/python3.12/site-packages/vllm/v1/worker/gpu_worker.py")
    source = path.read_text()
...
def patch_sparse_topk_for_small_context() -> None:
    ...
    """
    model_paths = (
        Path("/ai/vllm/DS4_SM120_Flash_VLLM_Experiment/venv/lib/python3.12/site-packages/vllm/model_executor/models/deepseek_v4.py"),
        Path("/ai/vllm/DS4_SM120_Flash_VLLM_Experiment/venv/lib/python3.12/site-packages/vllm/model_executor/models/deepseek_v2.py"),
    )
...
def patch_deepseek_v4_cache_gather_bounds() -> None:
    path = Path(
        "/ai/vllm/DS4_SM120_Flash_VLLM_Experiment/venv/lib/python3.12/site-packages/vllm/v1/attention/ops/"
...
def patch_mhc_reusable_buffers() -> None:
    path = Path("/ai/vllm/DS4_SM120_Flash_VLLM_Experiment/venv/lib/python3.12/site-packages/vllm/model_executor/layers/mhc.py")
    source = path.read_text()
...
def patch_tp_allreduce_diagnostic_bypass() -> None:
    path = Path("/ai/vllm/DS4_SM120_Flash_VLLM_Experiment/venv/lib/python3.12/site-packages/vllm/distributed/communication_op.py")
    source = path.read_text()
...
'''
    ...
    sampler_path = Path(
        "/ai/vllm/DS4_SM120_Flash_VLLM_Experiment/venv/lib/python3.12/site-packages/vllm/v1/sample/"
...
'''
    ...
    runner_path = Path(
        "/ai/vllm/DS4_SM120_Flash_VLLM_Experiment/venv/lib/python3.12/site-packages/vllm/v1/worker/"
        "gpu_model_runner.py"
    )
